...
export default function Home() {
  ...
  const [items] = useState<string[]>(['apple', 'banana', 'watermelon', 'blueberry']);
  const countRef = useRef<number>(0);
  const inputRef = useRef<null | HTMLInputElement>(null);
  const {
    count: hookCount,
    increment: hookCountIncrement,
    decrement: hookCountDecrement,
  } = useCounter(100);
  ...
  return (
    <div>
      ...
      <input ref={inputRef} type="text" className="border border-solid border-amber-400" />
